...
export default async function RootLayout({
  ...
  // 广告解锁配置
  let enableAdUnlock = false;
  let adUnlockAdUrl = '';
  let adUnlockCountdownSeconds = 5;
  ...
  const runtimeConfig = {
    ...
    ENABLE_AD_UNLOCK: enableAdUnlock,
    AD_UNLOCK_AD_URL: adUnlockAdUrl,
    AD_UNLOCK_COUNTDOWN_SECONDS: adUnlockCountdownSeconds,
