...
export function configSelfCheck(adminConfig: AdminConfig): AdminConfig {
  ...
  // 广告解锁默认值
  if (adminConfig.SiteConfig.EnableAdUnlock === undefined) {
    adminConfig.SiteConfig.EnableAdUnlock = false;
  }
  if (adminConfig.SiteConfig.AdUnlockAdUrl === undefined) {
    adminConfig.SiteConfig.AdUnlockAdUrl = '';
  }
  if (adminConfig.SiteConfig.AdUnlockCountdownSeconds === undefined) {
    adminConfig.SiteConfig.AdUnlockCountdownSeconds = 5;
  }
